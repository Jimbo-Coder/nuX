...
extern "C" void nuX_M0_InitData(CCTK_ARGUMENTS) {
  ...
  store_device_scalar(nuX_M0_nue_num_flux, CCTK_REAL(0.0));
  store_device_scalar(nuX_M0_nua_num_flux, CCTK_REAL(0.0));
  store_device_scalar(nuX_M0_nux_num_flux, CCTK_REAL(0.0));
  store_device_scalar(nuX_M0_nue_ene_flux, CCTK_REAL(0.0));
  store_device_scalar(nuX_M0_nua_ene_flux, CCTK_REAL(0.0));
  store_device_scalar(nuX_M0_nux_ene_flux, CCTK_REAL(0.0));
  ...
  amrex::ParallelFor(lsiz, [=] CCTK_DEVICE(int const ij) {
    ...
    nuX_M0_temp[ij] = 0.0;
    nuX_M0_Ye[ij] = 0.0;
    nuX_M0_abs_0_nue[ij] = 0.0;
    nuX_M0_abs_0_nua[ij] = 0.0;
    nuX_M0_abs_0_nux[ij] = 0.0;
