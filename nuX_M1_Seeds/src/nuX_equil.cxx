...
extern "C" void nuX_M1_Seeds_SetupNeutTest_equil(CCTK_ARGUMENTS) {
  DECLARE_CCTK_ARGUMENTS_nuX_M1_Seeds_SetupNeutTest_equil;
  DECLARE_CCTK_PARAMETERS;

  if (verbose)
    CCTK_INFO("nuX_M1_Seeds_SetupNeutTest_equil");
  ...
  grid.loop_all_device<1, 1, 1>(
      ...
      [=] CCTK_DEVICE(const PointDesc &p) CCTK_ATTRIBUTE_ALWAYS_INLINE {
        ...
        for (int is = 0; is < ncomponents; ++is) {
